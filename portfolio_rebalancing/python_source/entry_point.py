...
def solve_optimization(df_segments: pd.DataFrame, df_assets: pd.DataFrame, 
                       ...
                       consider_risk:bool = True, z_score: float = 1.96, profit_weight: float=None) ->pd.DataFrame:
    ...
    investment = optimize_portfolio(original_portfolio, risk_weight_limit, consider_risk=consider_risk, z_score=z_score, profit_weight=profit_weight)
